            ...
            <form action="<?php echo base_url('panel/temas/agregar') ?>" method="POST" class="form-horizontal" enctype="multipart/form-data">
              <fieldset>
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                    <input type="text" name="pbgcolor_franja" value="<?php echo set_value('pbgcolor_franja') ?>" class="input-xlarge" id="pbgcolor_franja" maxlength="10">
                  </div>
                </div>
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                    <select name="pfuente_cover" class="input-xlarge" id="pfuente_cover">
                      <option value="Opens sans light" <?php echo set_select('pfuente_cover', 'Opens sans light', false, $this->input->post('pfuente_cover')) ?>>Opens sans light</option>
                      <option value="Times New Roman" <?php echo set_select('pfuente_cover', 'Times New Roman', false, $this->input->post('pfuente_cover')) ?>>Times New Roman</option>
                      <option value="Rockwell regular" <?php echo set_select('pfuente_cover', 'Rockwell regular', false, $this->input->post('pfuente_cover')) ?>>Rockwell regular</option>
                    </select>
                  </div>
                </div>
