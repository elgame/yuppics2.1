        ...
        <div class="nav-collapse sidebar-nav">
          <ul class="nav nav-tabs nav-stacked main-menu">
            ...
            <li>
              ...
              <ul>
                <li><a class="submenu" href="<?php echo base_url('panel/cupones/') ?>"><i class="icon-list"></i><span class="hidden-tablet"> Administrar</span></a></li>
            ...
            <li>
              <a class="dropmenu" href="#"><i class="icon-picture"></i><span class="hidden-tablet"> Temas</span> <span class="label">2</span></a>
              <ul>
